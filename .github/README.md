...
[`@aws-sdk/client-device-farm`](https://www.npmjs.com/package/@aws-sdk/client-device-farm/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-device-farm@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lwKM2SsxX00aODb4MR+J++SWXI8Kx1bYhd1NVBKNfgWQUM+aZwDT+AksceDy69JQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-device-farm": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-device-farm@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-device-farm@3.995.0/index.min.mjs": "sha384-lwKM2SsxX00aODb4MR+J++SWXI8Kx1bYhd1NVBKNfgWQUM+aZwDT+AksceDy69JQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-device-farm/blob/refs/tags/3.995.0/LICENSE
```
